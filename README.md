...
In this project I created an app to display a list of books. It will also display the progress of the book as well as the information of the Author, the genre and the book title.
...
- git clone https://github.com/erickhansx/bookstore
